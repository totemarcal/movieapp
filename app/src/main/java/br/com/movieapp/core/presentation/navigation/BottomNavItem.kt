...
import br.com.movieapp.core.util.Constant.MOVIE_DETAIL_ARGUMENT_KEY
...
sealed class BottomNavItem(val title: String, val icon: ImageVector, val route: String) {
    ...
    object MovieDetail : BottomNavItem(
        ...
        route = "movie_details_destinatio?$MOVIE_DETAIL_ARGUMENT_KEY=" +
                "{$MOVIE_DETAIL_ARGUMENT_KEY}"
    ) {
        fun passMovieId(movieId: Int) =
            "movie_details_destinatio?$MOVIE_DETAIL_ARGUMENT_KEY=$movieId"
    }
}